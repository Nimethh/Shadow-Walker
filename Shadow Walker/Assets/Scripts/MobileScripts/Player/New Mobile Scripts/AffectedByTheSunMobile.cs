...
public abstract class AffectedByTheSunMobile : MonoBehaviour
{
    ...
    private PlayerSunBehaviorMobile playerSunBehavior;
    private LayerMask obstacleLayer;

    public void AffectedByTheSunScriptStart()
    {
        sun = GameObject.Find("Sun");
        playerSunBehavior = GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerSunBehaviorMobile>();
